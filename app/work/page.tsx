...
// components
import WorkSilderBtns from "@/components/WorkSilderBtns";
                ...
                <div className="flex flex-col xl:flex-row xl:gap[30px]">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <Link href={project.live}>
                                    <TooltipProvider delayDuration={100}>
                                        <Tooltip>
                                            <TooltipTrigger className="w-[50px] h-[50px] md:w-[55px] md:h-[55px] rounded-full bg-white/5 flex justify-center items-center group">
                    ...
                    <div className="w-full xl:w-[50%]">
                        ...
                        >
                            ...
                            <WorkSilderBtns containerStyles="flex gap-2 absolute right-0 bottom-[calc(50%_-_22px)] xl:bottom-0
